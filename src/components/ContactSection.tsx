            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 h-full">
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="https://www.instagram.com/ikshvaku.innovations/" className="bg-gray-100 hover:bg-gray-200 p-2 rounded-full transition-colors" aria-label="Facebook">
                  ...
                  <a href="http://youtube.com/@Ikshvaku.innovations" className="bg-gray-100 hover:bg-gray-200 p-2 rounded-full transition-colors" aria-label="YouTube">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormControl>
                          <Input type="text" placeholder="Subject" required {...field} />
                        </FormControl>
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormControl>
                          <Textarea placeholder="Message" rows={6} required {...field} />
                        </FormControl>
                      </FormItem>
                    )}
                  />
